...
import storm.task.tag.spout.kafka.KafkaSpout;
...
public class TagKafkaTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt(DATATOES_BOLT_ID, new TagDataToESBolt(),20).shuffleGrouping(KAFKA_SPOUT_ID);
        ...
        if(args != null && args.length > 0){
            ...
            cluster.submitTopology(TagKafkaTopology.class.getSimpleName(),config,builder.createTopology());
            Utils.sleep(10000);
            cluster.killTopology(TagKafkaTopology.class.getSimpleName());
            cluster.shutdown();
        }

package storm.task.tag_click.bolt.kafka;
 ...
 */
public class TagClickDataToESBolt extends BaseBasicBolt {
    private static final Logger logger = LoggerFactory.getLogger(TagClickDataToESBolt.class);
